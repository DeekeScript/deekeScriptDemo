...
export const Index = {
    ...
    intoMyPage() {
        ...
        Common.click(meTag);
        Common.sleep(2000);
        Log.log('点击me' + ":" + meTag.bounds().left + "::" + meTag.bounds().top);
    },
    ...
    intoMyLikeVideo() {
        ...
        let likeTag;
        while (sw-- > 0) {
            likeTag = new UiSelector().id('android:id/text1').textContains('喜欢').filter((v) => {
            ...
            Gesture.swipe(left, Device.height() * 2 / 3, left, Device.height() / 3, 300);
        }
    ...
    intoLocal() {
        ...
        let tj = undefined;
        for (let i in tjs) {
            if (!tjs[i].text() || !this.isCity(tjs[i].text())) {
                continue;
            }
            tj = tjs[i];
        }
        ...
        // Gesture.swipe(right + 200, top, right + 400, top, 300);
        // Common.sleep(1000);

        Common.id('yic').textContains(tj.text()).findOnce().parent().click();
        Common.sleep(3500);

        let tag = Common.id('close').filter((v) => {
        ...
        Gesture.click(Device.width() / 3 + Device.width() / 2 * Math.random(), meTag.bounds().top - 300);
        Common.sleep(1000);
    },
    ...
    intoRecommend() {
        ...
        Gesture.swipe(left, top, left - 300, top, 300);
        Common.sleep(1000);
